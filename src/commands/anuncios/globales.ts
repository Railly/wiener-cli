...
export async function runAnunciosGlobales(opts: {
  ...
  try {
    ...
    if (anuncios.length === 0) {
      console.log(pc.dim("No hay anuncios globales. (La cuenta institucional puede tener ID distinto a 1.)"));
    ...
    console.log(renderSection("Anuncios globales", renderTable(rows, [
