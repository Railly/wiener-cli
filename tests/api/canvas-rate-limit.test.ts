...
describe("WienerError", () => {
  it("has correct code and message", () => {
    const e = new WienerError("canvas-token-invalid", "PAT rejected", "Regenerate via wiener auth canvas pat new");
  ...
  it("toErrorEnvelope converts WienerError correctly", () => {
    const e = new WienerError("rate-limited", "Too many requests", "Wait 60s");
